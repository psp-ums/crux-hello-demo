...
/**
  * Language enumeration (ISO 3166, for simplicity)
  *
  * @author psp
  * @since 2016.07.14
  */
...
object Lang extends Enumeration {
  type Lang = Value
  val AD, AE, AF, AG, AI, AL, AM, AO, AQ, AR, AS, AT, AU, AW, AX, AZ, BA, BB, BD, BE, BF, BG, BH, BI, BJ, BL, BM, BN,
  ...
  UM, US, UY, UZ, VA, VC, VE, VG, VI, VN, VU, WF, WS, YE, YT, ZA, ZM, ZW = Value
  def valueOf(name: String): Lang = this.withName(name)
}
